...
- TBD at shell layout: chunky momentary "goodnight button" (see CLAUDE.md,
  session end).
- TBD at shell layout: potentiometer for the grumpiness knob — scales
  how chatty Mike is (software.md, Voice) — the housing gets embossed
  lettering: GRUMPINESS. This label is canon.
